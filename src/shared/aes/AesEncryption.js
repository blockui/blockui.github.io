...
export default class AesEncryption {
  ...
  encrypt(data, password) {
    ...
    try {
      ...
      console.log("encrypt time: ",+(new Date()) - startTime)
      return encrypted;
    } catch (err) {
  ...
  decrypt(data, password) {
    try {
      ...
      console.log("decrypt time: ",+(new Date()) - startTime)
